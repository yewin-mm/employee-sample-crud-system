...
public class EmployeeService {
    ...
    @Transactional
    // transactional for roll back. eg. we saved into employee table and when we save into user table, at that time, when error was thrown, the employee save data will be roll back.
    public ResponseEntity insertEmployee(String empName, String empAddress, String priPhone, String secPhone, String empEmail) {
        ...
        /**
         * Actually, above count query can't cover for unique id, when you physically delete database one row.
         * You should retrieve last EMP id from last row for cover than retrieving total count.
         */
